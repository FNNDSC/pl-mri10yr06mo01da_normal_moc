#!/usr/bin/env python
#                                                            _
# mri10yr06mo01da_normal_moc fs app
#
...
Gstr_synopsis = """
    ...
    NAME
        ...
        mri10yr06mo01da_normal_moc.py

    SYNOPSIS

        python mri10yr06mo01da_normal_moc.py                            \\
    ...
    BRIEF EXAMPLE
        ...
        * Copy the (container) internal data to the output directory:
            ...
            python mri10yr06mo01da_normal_moc.py out

    DESCRIPTION

        `mri10yr06mo01da_normal_moc.py` simply copies internal MRI data to the
    ...
    versions of this app).
        ...
        mkdir out && chmod 777 out
        mri10yr06mo01da_normal_moc.py out

    Copy a user specified directory to the ``out`` directory
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

        mkdir out && chmod 777 out
        mri10yr06mo01da_normal_moc.py --dir /usr/src/data out
...
class MRI10yr06mo01da_normal_moc(ChrisApp):
    """
...
if __name__ == "__main__":
    app = MRI10yr06mo01da_normal_moc()
    app.launch()
